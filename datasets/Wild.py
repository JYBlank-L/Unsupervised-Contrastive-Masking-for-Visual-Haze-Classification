...
def ucmImage(image_path, labels, crop_size, filters, method, category):
    ...
    np.save('./data/haze_wild/' + category + '/image.npy', np.array(image_list))
    np.save('./data/haze_wild/' + category + '/label.npy', np.array(label_list))
